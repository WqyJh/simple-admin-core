...
require (
	...
	github.com/suyuan32/simple-admin-job v1.2.0
	github.com/suyuan32/simple-admin-message-center v1.2.0
...
require (
	...
	github.com/WqyJh/confcrypt v0.1.0 // indirect
...
replace github.com/zeromicro/go-zero v1.6.0 => github.com/WqyJh/simple-admin-tools v1.6.0-3
